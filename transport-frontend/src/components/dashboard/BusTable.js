                    ...
                    {props.rows.length > 0 && props.rows.map((row) => {
                        return (
                            <StyledTableRow key={row._id}>
                                <StyledTableCell style={{width: "12%"}} align="left">{row.busNumber}</StyledTableCell>
                                <StyledTableCell style={{width: "15%"}} align="left">{row.busName}</StyledTableCell>
                                <StyledTableCell style={{width: "10%"}} align="left">{row.noOfSeats}</StyledTableCell>
